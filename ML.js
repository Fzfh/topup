 ...
 const membershipNominals = `
     ...
     <div class="denom-item" onclick="selectDenom(this, 'Weekly Diamond Pass 2x', 'Rp 57.000')">
         <img src="https://i.imgur.com/PmJnFKp.png" alt="">
         <p>Weekly Diamond Pass 2x</p>
         <p>Rp 57.000</p>
     </div>
     <div class="denom-item" onclick="selectDenom(this, 'Weekly Diamond Pass 3x', 'Rp 85.000')">
         <img src="https://i.imgur.com/PmJnFKp.png" alt="">
         <p>Weekly Diamond Pass 3x</p>
         <p>Rp 85.000</p>
     </div>
